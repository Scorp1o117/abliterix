#!/bin/bash
# Ling-3.0-flash v58: dump steered final-prefill residuals under exact primary
...
SOURCE_CKPT="checkpoints_ling30_flash_v57_harmfulness_counterfactual"
...
exec abliterix \
  ...
  --steering.dump-steered-prefill-residuals \
