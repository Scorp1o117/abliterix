#!/bin/bash
# Ling-3.0-flash v15: matched post-attention-residual prescreen
...
CONFIG="${ABLITERIX_CONFIG:-configs/ling30_flash_rocm_v15_post_attn.toml}"
...
echo "=== Ling-3.0-flash v15 POST-ATTENTION RESIDUAL PROBE ==="
echo "  site: residual + attention_output, before post-attention norm"
echo "  profile: exact v13 t2"
