#!/bin/bash
# Ling-3.0-flash v41: rank-2 gated angular subspace probe
...
# The baseline and generated gate-training responses are direction-independent.
# Do not copy the v36 steering cache: v41 changes its shape from rank 1 to rank 2.
