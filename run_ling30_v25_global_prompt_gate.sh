#!/bin/bash
# Ling-3.0-flash v25: layer-0 global prompt gate, 400/class generated data
...
echo "=== Ling-3.0-flash v25 GLOBAL PROMPT GATE ==="
echo "  classifier: v24 400/class generated trajectories"
echo "  decision: layer 0 final-prefill, broadcast to all later layers"
echo "  generation: full 100 only if layer-0 external guard passes"

exec abliterix \
  --config "$CONFIG" \
  --seed 117 \
  --steering.concept-gate-scope global_prompt \
  --steering.concept-gate-global-decision-layer 0 \
