#!/bin/bash
# Ling-3.0-flash v54: anonymous strength-routing feature telemetry
...
SOURCE_CKPT="checkpoints_ling30_flash_v53_projection_geometry_calibration"
