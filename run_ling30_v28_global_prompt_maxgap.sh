#!/bin/bash
# Ling-3.0-flash v28: max-gap global prompt layer at/before profile start
...
echo "=== Ling-3.0-flash v28 MAX-GAP GLOBAL PROMPT GATE ==="
echo "  selection: max internal active-gap among layers 0..20"
echo "  validation: independent external guard"
